...
public class AccountEntity extends Entity
{
    ...
    /**
     * This method is used to calculate the dollar amount owed on a loan.
     * @return double
     */
    public double calculateInterestDollarAmount() {
       return ( ((this.BALANCE / 2 ) * lengthInYears * INTEREST_RATE ) * lengthInMonths );
    }
